...
import { getByGradeRelawan } from '../../../../../app/model/relawan/relawanSlice';
...
const GradeA = () => {
    ...
    const getData = async(data) => {
        try {
            await dispatch(getByGradeRelawan(data)).unwrap().catch((err) => {});
        } catch (error) {
    ...
    const handlePagination = (page) => {
        if (page === 0) {
            ...
            return getData({grade: 'a', page:page});
        }
    }
            ...
            <div>
                <div className="card">
                    <div className="card-body">
                        <div>
                            <FormTitle title={'DATA RELAWAN GRADE A'} />
                        </div>
